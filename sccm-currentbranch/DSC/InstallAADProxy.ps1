...
$Configuration.InstallAADProxy.Status = 'Running'
$Configuration.InstallAADProxy.StartTime = Get-Date -format "yyyy-MM-dd HH:mm:ss"
...
$Configuration.InstallAADProxy.Status = 'Completed'
$Configuration.InstallAADProxy.EndTime = Get-Date -format "yyyy-MM-dd HH:mm:ss"
$Configuration | ConvertTo-Json | Out-File -FilePath $ConfigurationFile -Force
