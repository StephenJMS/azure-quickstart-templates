...
$logpath = $ProvisionToolPath+"\InstallTunGWLog.txt"
$ConfigurationFile = Join-Path -Path $ProvisionToolPath -ChildPath "$Role.json"
$Configuration = Get-Content -Path $ConfigurationFile | ConvertFrom-Json

$Configuration.InstallTunGW.Status = 'Running'
$Configuration.InstallTunGW.StartTime = Get-Date -format "yyyy-MM-dd HH:mm:ss"
...
$Configuration.InstallTunGW.Status = 'Completed'
$Configuration.InstallTunGW.EndTime = Get-Date -format "yyyy-MM-dd HH:mm:ss"
$Configuration | ConvertTo-Json | Out-File -FilePath $ConfigurationFile -Force
